...
ObjectDCMotor.prototype.GetCode = function(passedVars) {
	...
	var selfSetupCode = (Ports["p"+MotorsPortDirection[this.Port]] == undefined) ? "pinMode(" + MotorsPortDirection[this.Port] + ", OUTPUT);" : "";
    Ports["p" + MotorsPortDirection[this.Port]] = MotorsPortDirection[this.Port];    
...
ObjectDCMotor.prototype.UpdatePort = function UpdatePort(port) {
	this.Port = port;
