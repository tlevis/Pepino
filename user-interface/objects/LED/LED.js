...
ObjectLED.prototype.Draw  = function(offset, working_area) {
    ...
    if (this.SetupMode == false)
    {
        ...
        body += "<div id=\"" + this.Id +"_port_number_div\" style=\"font-family: 'ohw-font'; color: white; position: absolute; top: 20px; right: 13px; width: 25px; text-align:center\">" + this.Port + "</div>";
...
ObjectLED.prototype.DrawSettingsPanel  = function() {
	...
	if (this.PortType == OutputPortTypes.DIGITAL) {
        ...
        {        
            body += "       <select id=\"" + this.Id + "_pwm_value\" onblur=\"updatePWMVariable('" + this.Id + "', 1, this.value)\" onchange=\"updatePWMVariable('" + this.Id + "', 1, this.value)\">";
        ...
        {
            body += "<select id='" + this.Id + "_pwm_value' onblur=\"updatePWMVariable('" + this.Id + "',2, this.value)\" onchange=\"updatePWMVariable('" + this.Id + "',2, this.value)\">";
...
ObjectLED.prototype.UpdatePort = function UpdatePort(port) {
	this.Port = port;
